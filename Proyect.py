...
st.caption("Data Mining · Universidad de la Costa · Prof. José Escorcia-Gutierrez, Ph.D.")
...
st.caption("Proyecto final de Minería de Datos · Iris Species Classification")
